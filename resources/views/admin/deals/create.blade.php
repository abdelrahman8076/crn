...
<div class="container-fluid py-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active fw-bold text-primary" aria-current="page">{{ isset($deal) ? __('deals.edit_title') : __('deals.create_title') }}</li>
        </ol>
    </nav>
                ...
                <div class="card-header bg-white py-3 border-bottom-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="text-muted small mb-0">{{ __('deals.form_subtitle') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ isset($deal) ? route('admin.deals.update', $deal->id) : route('admin.deals.store') }}" method="POST">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <h6 class="fw-bold text-uppercase small text-primary mb-3 border-bottom pb-2">
                                    <i class="ti ti-info-circle me-1"></i> {{ __('deals.deal_details') }}
                                </h6>
                            </div>

                            <div class="col-md-8">
                                <label for="deal_name" class="form-label fw-bold small">{{ __('deals.deal_name') }} *</label>
                                <div class="input-group">
                                    ...
                                    <input type="text" name="deal_name" id="deal_name" 
                                           ...
                                           value="{{ old('deal_name', $deal->deal_name ?? '') }}" required placeholder="e.g. Q3 Software License">
                                </div>
                                @error('deal_name') <div class="text-danger extra-small mt-1">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-md-4">
                                <label for="amount" class="form-label fw-bold small">{{ __('deals.amount') }} *</label>
                                <div class="input-group">
                            ...
                            {{-- Section 2: Pipeline & Client --}}
                            <div class="col-12 mt-5">
                                <h6 class="fw-bold text-uppercase small text-primary mb-3 border-bottom pb-2">
                                    <i class="ti ti-settings-automation me-1"></i> {{ __('deals.pipeline_status') }}
                                </h6>
                            </div>

                            <div class="col-md-6">
                                <label for="client_id" class="form-label fw-bold small">{{ __('deals.client') }} *</label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6">
                                <label for="stage" class="form-label fw-bold small">{{ __('deals.stage') }} *</label>
                                <div class="input-group">
                        ...
                        <div class="mt-5 pt-4 border-top d-flex justify-content-end gap-2">
                            <a href="{{ route('admin.deals.index') }}" class="btn btn-light px-4">{{ __('deals.cancel') }}</a>
                            <button type="submit" class="btn btn-primary px-5 shadow-sm">
                                <i class="ti ti-device-floppy me-1"></i> {{ isset($deal) ? __('deals.update') : __('deals.save') }}
                            </button>
                        </div>
                    </form>
                </div>
