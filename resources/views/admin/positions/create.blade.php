...
<div class="page-wrapper p-4" style="background-color: #f4f7fa; min-height: 100vh;">
    <div class="row mb-4 align-items-center">
        <div class="col-md-6">
            <h3 class="fw-bold text-dark mb-1 tracking-tight">Create Position</h3>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-white py-3 border-bottom border-light d-flex align-items-center gap-2">
                    ...
                    <h5 class="card-title mb-0 fw-bold">New Position</h5>
                </div>
                    ...
                    <form action="{{ route('admin.positions.store') }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name" 
                                           ...
                                           value="{{ old('name') }}" placeholder="e.g., Team Manager, Sales Director" required>
                                </div>
                                @error('name')
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">Select parent to create hierarchy. Level will be calculated automatically.</small>
                                @error('parent_id')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">Lower numbers appear first at same level</small>
                                @error('sort_order')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
